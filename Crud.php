...
if (!$result) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        <tr>
            ...
            <td>
                <a href="updatepage1.php?id=<?php echo $row['id']; ?>" class="btn btn-warning">Edit</a>
                <a href="deletepage1.php?id=<?php echo $row['id']; ?>" class="btn btn-danger">Delete</a>
            </td>
        </tr>
        <?php
    }
            ...
            <div class="modal-body">
                <form method="POST" action="insert_data.php" id="addStudentForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="school_level" name="school_level" readonly>
                    </div>
                    <div class="mb-3">
                        <label for="region" class="form-label">Region</label>
                        <input type="text" class="form-control" id="region" name="region" value="VII" readonly>
                    </div>
                    <div class="mb-3">
                        <label for="division" class="form-label">Division</label>
                        <input type="text" class="form-control" id="division" name="division" value="CEBU" readonly>
                    </div>
                    <div class="mb-3">
